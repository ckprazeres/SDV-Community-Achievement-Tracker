...
module.exports = function(sequelize, DataTypes) {
  var Bulletinboard = sequelize.define('Bulletinboard', {
    ...
    bulletinboard_completed: DataTypes.BOOLEAN,
    chefs_completed: DataTypes.BOOLEAN,
    ...
    dye_completed: DataTypes.BOOLEAN,
    ...
    fieldresearch_completed: DataTypes.BOOLEAN,
