...
module.exports = function(sequelize, DataTypes) {
  var Fishtank = sequelize.define('Fishtank', {
    ...
    fishtank_completed: DataTypes.BOOLEAN,
    riverfish_completed: DataTypes.BOOLEAN,
    ...
    lakefish_completed: DataTypes.BOOLEAN,
    ...
    oceanfish_completed: DataTypes.BOOLEAN,
    ...
    specialtyfish_completed: DataTypes.BOOLEAN,
