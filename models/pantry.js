...
module.exports = function(sequelize, DataTypes) {
  var Pantry = sequelize.define('Pantry', {
    ...
    springcrops_completed: DataTypes.BOOLEAN,
    ...
    summercrops_completed: DataTypes.BOOLEAN,
    ...
    fallcrops_completed: DataTypes.BOOLEAN,
    ...
    qualitycrops_completed: DataTypes.BOOLEAN,
    ...
    animal_completed: DataTypes.BOOLEAN,
    ...
    artisan_completed: DataTypes.BOOLEAN,
